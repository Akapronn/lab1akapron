...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme:
            ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 228, 248, 2)),
        useMaterial3: true,
      ),
      home: MyAppPage(),
    );
...
class MyAppPage extends StatelessWidget {
  ...
  Widget displayNameItem({required String name, required String imagePath}) {
    bool isHighlight = name == "อฆพร ไร่ขาม 643450334-3";
    return Container(
      padding: const EdgeInsets.all(10),
      color:
          isHighlight ? Color.fromARGB(255, 0, 0, 0) : Colors.transparent,
      child: Row(
        children: [
          Image(
            width: 100,
